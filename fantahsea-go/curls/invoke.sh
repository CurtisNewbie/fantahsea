...
curl -X GET "http://localhost:8081/fantahsea/open/gallery/image/download?imageNo=IMG5FBBD6P84OE7UT4Q" -H "id: 1" -H "username: zhuangyongj" -H "userno: 123" -H "role: admin" -v -o abc.png 
